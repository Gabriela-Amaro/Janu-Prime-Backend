...
class AdministradorAdmin(admin.ModelAdmin):
    list_display = ('usuario__id', 'usuario__email', 'estabelecimento__nome', 'nome', 'cpf', 'super_user', 'usuario__created_at', 'usuario__updated_at')
...
class ClienteAdmin(admin.ModelAdmin):
    list_display = ('usuario__id', 'usuario__email', 'nome', 'cpf', 'telefone', 'pontos', 'usuario__created_at', 'usuario__updated_at')
